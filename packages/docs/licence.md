...
application, so in practice the AGPL is enough when:
...
It covers use in closed-source and proprietary products with no obligation to
release your own source, the right to distribute the library inside your
application, and terms — scope, seats, support, duration — agreed in writing.
